//=============================================================================
// File: NavigateViaTrackmarkCommand.gs
// Desc: 
//=============================================================================
include "DriverCommand.gs"
include "World.gs"
include "KUID.gs"
include "NavigateViaTrackmarkScheduleCommand.gs"



//=============================================================================
// Name: NavigateViaTrackmarkCommand
// Desc: 
//=============================================================================
class NavigateViaTrackmarkCommand isclass DriverCommand
{
  //=============================================================================
  // Name: Init
  // Desc: 
  ...
  {
    NavigateViaTrackmarkScheduleCommand cmd = new NavigateViaTrackmarkScheduleCommand();
    cmd.Init(driver, me);
    cmd.SetParent(me);
