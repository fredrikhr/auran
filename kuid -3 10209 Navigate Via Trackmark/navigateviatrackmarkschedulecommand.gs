//=============================================================================
// File: NavigateViaTrackmarkScheduleCommand.gs
// Desc: 
//=============================================================================
...
include "KUID.gs"
include "Industry.gs"
include "NavigateViaTrackmarkCommand.gs"
include "Schedule.gs"


//=============================================================================
class NavigateViaTrackmarkScheduleCommandData
{
...
//=============================================================================
// Name: NavigateViaTrackmarkCustomCommand
// Desc: 
//=============================================================================
class NavigateViaTrackmarkCustomCommand isclass CustomCommand
{
  public NavigateViaTrackmarkScheduleCommandData m_data;
  ...
  public bool Execute(Train train, int px, int py, int pz)
  {
    ...
    {
      Interface.Log("NavigateViaTrackmarkScheduleCommand> Failed to load trackmark: " + m_data.m_trackMarkID.GetDebugString());
      train.Sleep(5);
      return false;
    }
...
//=============================================================================
// Name: NavigateViaTrackmarkScheduleCommand
// Desc: 
//=============================================================================
class NavigateViaTrackmarkScheduleCommand isclass DriverScheduleCommand
{
  NavigateViaTrackmarkCommand             parent;
  NavigateViaTrackmarkScheduleCommandData m_data;

  public obsolete string trackmarkName;


  public void SetParent(NavigateViaTrackmarkCommand newParent)
  {
    parent = newParent;
  }
  ...
  public bool UpdateExecute(DriverCharacter driver)
  {
    if (!m_data.m_trackMark)
    {
      ...
      NavigateViaTrackmarkCustomCommand command = new NavigateViaTrackmarkCustomCommand();
    ...
    if (!HasReachedDestination(driver))
    {
      ...
      driver.NavigateThroughTrackside(m_data.m_trackMark);
      return true;
    }
  ...
  obsolete void ObsoleteLoadTrackmarkByName(string trackMarkName)
  {
    ...
    {
      Interface.Log("NavigateViaTrackmarkScheduleCommand.ObsoleteLoadTrackmarkByName> Failed to find trackmark: " + trackMarkName);
  ...
  {
    m_data = new NavigateViaTrackmarkScheduleCommandData();
