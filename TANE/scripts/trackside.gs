...
game class Trackside isclass MapObject
{
  ...
  public string GetDescriptionHTML()
  {
    ...
    if (GetTrackBumpPitchAngle() != 0.0f or GetTrackBumpRollAngle() != 0.0f)
    {
      ...
      htmlString = htmlString + "<tr><td>" + strTable.GetString("trackside_prop_bump_pitch") + ":</td><td><a href='live://property/bump-pitch'>" +  GetTrackBumpPitchAngle() + "</a></td></tr>";
      htmlString = htmlString + "<tr><td>" + strTable.GetString("trackside_prop_bump_roll") + ":</td><td><a href='live://property/bump-roll'>" +  GetTrackBumpRollAngle() + "</a></td></tr>";
      htmlString = htmlString + "</table>";
    }
