...
//
final static class Interface isclass GameObject
{
  ...
  //! Prints a line of text to the Trainz log file.
  //
  ...
  //! Shows the planet auran login details dialog
  //
  ...
  // 
  // The warning goes to the Trainz log file and is not visible to the casual user within
  ...
  //
  // Generates a log of the current call stack and places it in the Trainz log file.
  //
