...
//       This class handles the actual driving of the train for its parent
//       DriverCommand in a DriverCharacter's schedule.  A DriverCommand object
//       is responsible for creating a DriverScheduleCommand and placing it on
//       the driver's list.
//=============================================================================
