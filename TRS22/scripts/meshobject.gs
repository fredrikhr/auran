...
game class MeshObject isclass PropertyObject, TrainzGameObject
{
  ...
  //=============================================================================
  public legacy_compatibility void Init(Asset asset);
  ...
  // Parm: meshName - Name of the mesh to set the animation state for.
  // Parm: frame - Frame to set the animaition to.
  //=============================================================================
  ...
  // Parm: meshName - Name of the mesh to set the animation state for.
  // Parm: frame - Frame to set the animaition to.
  // Parm: interpTime - Duration (seconds) over which to move to the specified
  //       frame.
  //=============================================================================
  ...
  //=============================================================================
  // Name: SetMeshAnimationFrameLegacy
  // Desc: A broken version of SetMeshAnimationFrame(), provided solely to 
  //       allow an upgrade path for content which was tuned to work with the
  //       broken behavior and which can't easily be fixed for the corrected
  //       behavior that is present in modern Trainz versions. This is only
  //       required when the asset in question is being upgraded; old assets
  //       will automatically use the broken behaviour to avoid introducing
  //       unwanted changes.
  // Note: It is obviously preferred that you fix your asset during any upgrade
  //       rather than simply changing it to call this function. This function
  //       is provided in acknowledgment of the fact that the person attempting
  //       an upgrade/repair of an old asset may not have access to the source
  //       files required to properly fix the animation.
  //=============================================================================
  public native obsolete void SetMeshAnimationFrameLegacy(string meshName, float frame, float interpTime);
  public obsolete void SetMeshAnimationFrameLegacy(string meshName, float frame) { SetMeshAnimationFrameLegacy(meshName, frame, 0.0); }
  ...
  // Retn: MeshObject - Legacy return value. No longer usable.
  //=============================================================================
