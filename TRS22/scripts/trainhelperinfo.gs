...
class AssetTypeInfo isclass TrainHelperInfoListBase
{
  ...
  AsyncTrainzAssetSearchObject BeginAssetSearch()
  {
    ...
    AddHandler(search, "TrainzAssetSearch", "AsyncResult", "OnAsyncSearchResult");
  ...
  //=============================================================================
  public legacy_compatibility void UpdateInteralListFromLegacyFormat(void)
  {
  ...
  public void SetProperties(Soup soup)
  {
    ...
    if (soup.GetIndexForNamedTag(Prop("itemslist")) != -1)
    {
      ...
      else if (!m_assetSearch)
      {
        // Search now, so that our data is hopefully updated before anyone tries to use it
        m_assetSearch = BeginAssetSearch();
      }
    }
    else
