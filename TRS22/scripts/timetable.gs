...
static class Timetable
{
  ...
  //     Schedule::Announce()
  //
  public obsolete bool Announce(string stateName, int srcId);
  ...
  //     Schedule::OnAnnounce()
  //
  public obsolete bool OnAnnouncement(string stateName, int notifyId);
  ...
  //     Schedule::OnAnnounce()
  //
  public obsolete bool OnAnnouncement(GameObject runningThread, string stateName);
  ...
  public obsolete bool OnAnnouncement(string stateName, int notifyNode)
  {
    int i, numStates = states.size(), j;
    TimetableState state;
