...
// Desc: Provides base functionality for the static TrainzScript and World
//       classes, which are used by scripts to perform various basic functions
//       (like asset loading, object searching, and querying basic game state).
//=============================================================================
class TrainzScriptBase  isclass GameObject, ScriptLogBase
{
  ...
  public define int PRODUCTRIGHT_WORLD_OF_RAIL = 22;   // Obsolete. Will be removed.
  public define int PRODUCTRIGHT_RAILYARD = 23;
  public define int PRODUCTRIGHT_TS17UI = 24;
  public define int PRODUCTRIGHT_UNIFIED_DRIVER_SURVEYOR = 25;
  public define int PRODUCTRIGHT_SURVEYOR_CAMERAS = 26;
  ...
  //       code. The functionality and interface is expected to change often and
  //       without notice (even between minor Trainz patches).
  //=============================================================================
  ...
  //       to the maximum supported asset version number of the game (as per the
  //       trainz-build config file tag).
  ...
  //=============================================================================
  // Name: GetTrainzBuild
  // Desc: Gets the current build number of this installation of Trainz. The
  //       value returned corresponds to the build number you can see in the
  //       Trainz menu/launcher/etc.
...
//=============================================================================
// Name: TrainzScript
// Desc: The static implementation for TrainzScriptBase. (Required since World
//       also inherits from TrainzScriptBase.)
//=============================================================================
