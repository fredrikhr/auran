...
final game class Menu isclass GSObject
{
  ...
  //=============================================================================
  // Name: InitialiseAsMapObjectSelector
  // Desc: Initialises this Menu object to automatically add map objects matching
  //       a specific category filter. This menu will dynamically generate sorted
  //       sub-menus as required.
  //       Upon selection of a menu item by the player, a message will be posted
  //       to msgDst, using the msgMajor string provided and with the message
  //       parameter soup containing the following data:
  //        object-id       (GameObjectID) - The ID of the object selected
  //        object-name     (string) - The localised name of the object selected
  //=============================================================================
  public native void InitialiseAsMapObjectSelector(string categoryFilter, GameObject msgDst, string msgMajor);
  ...
  public void AddItem(string name, GameObject dstObject, string major, string minor) { AddItem(name, dstObject, major, minor, null); }
	...
	//                  this menu.
	//
	public native void AddSubmenu(string name, Menu submenu, KUID icon);
  public void AddSubmenu(string name, Menu submenu) { AddSubmenu(name, submenu, null); }
