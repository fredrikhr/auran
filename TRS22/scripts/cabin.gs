...
class Cabin isclass MeshObject
{
  ...
  // Called when this cabin is begin detached from its parent object. It will be destroyed following this call,
  // so now is a good time to clean up any external references that you may have been keeping.
