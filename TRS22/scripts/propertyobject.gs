...
game class PropertyObject
{
  ...
  // Internal implementation helper for SetProperties().
  // Never call this directly; it will be removed in the future.
  native void InternalTouchProperties(void);
