...
//
// See Also:
//     Buildable, GenericIndustry, BaseIndustry, SceneryWithTrack, IndustryTrainController,
//      ProductQueue, Vehicle, World.GetNamedObjectList(), Train.GetLastVisitedIndustry()
//
