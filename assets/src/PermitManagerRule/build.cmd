...
MD "..\..\bin\PermitManagerRule"
XCOPY "." "..\..\bin\PermitManagerRule" /E /C /H /Y /EXCLUDE:excludefiles.txt
COPY /Y "..\PermitManagerShared.gs" "..\..\bin\PermitManagerRule"

PUSHD "..\..\bin\PermitManagerRule"
FOR /R . %%G IN (*.gs) DO (
