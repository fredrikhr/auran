...
class TrainzScriptBase
{
  //! Creates an instance of the specified library asset.
  //
  // Note:
  //     See the Library class for more information on library assets.
  //
  // Param:  kuid  KUID of the library asset to load and return.
  //
  // Return:
  //     Returns a loaded instance of the Library asset if successful, null otherwise.
  //
  // See Also:
  //     Library, Library::LibraryCall()
  //
  public native Library GetLibrary(KUID kuid);



  //! Gets the asset that corresponds to the given KUID.
  //
  // Param:  kuid  KUID of asset to get a handle to.
  //
  // Returns:
  //     Returns the Asset object that corresponds to KUID if possible, null otherwise.
  //
  public native Asset FindAsset(KUID kuid);



  //! Gets all the assets of the given kind.
  //
  // Param:  kind  Name of asset kind to get the assets for.
  //
  // Returns:
  //     Return all installed assets that are of type <i kind>.
  //
  public native Asset[] GetAssetList(string kind);
  public native Asset[] GetAssetList(string kind, string customCategoryList);


  // ============================================================================
  // Name: SearchAssets
  // Desc: Search the asset database for assets matching the specified 
  //       categories.
  // Parm: categoryFilter - A filter based on the native TAD categories for the 
  //       assets. These do not correspond with any user-visible category values.
  // Parm: bSearchLocalAssetsOnly - If set, restricts the search to locally
  //       available content.
  // Parm: KUID[] - The found assets.
  // ============================================================================
  public native KUID[] SearchAssets(string categoryFilter, bool bSearchLocalAssetsOnly);


  // ============================================================================
  // Name: FindUpdatedAssets
  // Desc: Search the asset database for DLS updates to local assets.
  // Retn: Asset[] - The list of updated assets on the DLS.
  // ============================================================================
  public native Asset[] FindUpdatedAssets();
  ...
  // Retn: Soup - reserved.
  // ============================================================================
  public native Soup TrainzSystemCall(string name, Soup param);
